...
/**
 * This simulator uses an {@link DifferentialDriveStateEstimator} to simulate the state of the
 * drivetrain. In simulationPeriodic, users should first set inputs from motors with
 ...
 */
public class SimDifferentialDrivetrain {
   ...
   */
  public SimDifferentialDrivetrain(LinearSystem<N2, N2, N2> drivetrainPlant,
