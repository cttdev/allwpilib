...
public class SimSwerveDrive {
  ...
  public void update(double dtSeconds) {
    ...
    m_x = RungeKutta.rungeKutta((x, u) -> u, m_x,
        VecBuilder.fill(netLinearAcceleration.getX(), netLinearAcceleration.getY(),
