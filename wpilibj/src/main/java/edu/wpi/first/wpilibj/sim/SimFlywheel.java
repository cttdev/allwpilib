...
public class SimFlywheel extends SimLinearSystem<N1, N1, N1> {
   ...
   */
  public SimFlywheel(LinearSystem<N1, N1, N1> flywheelPlant, boolean addNoise, Matrix<N1, N1> m_measurementStdDevs,
                     DCMotor flywheelGearbox, double gearing) {
    super(flywheelPlant, addNoise, m_measurementStdDevs);
